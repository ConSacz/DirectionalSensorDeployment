...
% % case1 result
% for i = 1:numel(x)
%    name = ['./area_coverage/case 1/case1_', num2str(i), '.mat']; 
...
% % case2 result
% for i = 1:numel(x)
%    name = ['./area_coverage/case 2/case2_', num2str(i), '.mat']; 
%    load(name, 'BestCost', 'it');
...
% % case3 result
% for i = 1:numel(x)
%    name = ['./area_coverage/case 3/case3_', num2str(i), '.mat']; 
%    load(name, 'BestCost', 'it');
...
% % case4 result
% for i = 1:numel(x)
%    name = ['./area_coverage/case 4/case4_', num2str(i), '.mat']; 
%    load(name, 'BestCost', 'it');
...
load("./zResult matrixes/area.mat");
